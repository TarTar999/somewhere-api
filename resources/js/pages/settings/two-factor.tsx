                    ...
                    {twoFactorEnabled ? (
                        <div className="flex flex-col items-start justify-start space-y-4">
                            ...
                            <p className="text-muted-foreground">
                                ...
                                vous devrez entrer un code sécurisé lors de la
                                connexion, que vous pouvez récupérer depuis une
                        ...
                        <div className="flex flex-col items-start justify-start space-y-4">
                            ...
                            <p className="text-muted-foreground">
                                ...
                                facteurs, vous devrez entrer un code sécurisé lors
                                de la connexion. Ce code peut être récupéré depuis
